...
const Dashboard: React.FC<DashboardProps> = ({ metrics, videos, keyword }) => {
  ...
  const getVolumeColor = (level: string) => {
    switch (level) {
      case 'Mega': return 'text-pink-700 bg-pink-100 border-pink-200 ring-2 ring-pink-100';
      case 'Huge': return 'text-purple-700 bg-purple-100 border-purple-200 ring-2 ring-purple-100';
      case 'Large': return 'text-red-700 bg-red-100 border-red-200 ring-2 ring-red-100';
      case 'Medium': return 'text-orange-700 bg-orange-100 border-orange-200 ring-2 ring-orange-100';
      case 'Small': return 'text-blue-700 bg-blue-100 border-blue-200 ring-2 ring-blue-100';
    ...
    <div className="mb-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex flex-col justify-between relative group hover:border-purple-300 transition-colors cursor-help h-[220px]">
          ...
          <div className="absolute top-full left-0 mt-2 hidden group-hover:block bg-slate-900 text-white text-xs p-4 rounded-xl z-30 w-72 shadow-2xl border border-slate-700">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex flex-col justify-between relative group hover:border-red-300 transition-colors cursor-help h-[220px]">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="mt-1">
              ...
              {/* Progress Bar */}
              <div className="w-full bg-slate-100 rounded-full h-4 overflow-hidden border border-slate-100">
                  <div 
